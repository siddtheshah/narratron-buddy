...
In terms of big features, there's a lot of directions to explore.

On the canvas side:
- Better image generation (using better models)
- Layered imagery
- Improved Animation
- Improving Scene to scene cohesion.

On the creator side:
- User profile page
- Asset hub
- Wiki (knowledge base) ingestion

And there's all the other scaling issues to deal with. But I'm really keen to go to sleep.