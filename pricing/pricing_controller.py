...
class PricingController:
    ...
    def calculate_usage_cost(
        self, voice_minutes: float = 0.0, images_created: int = 0
    ) -> float:
        """Calculate total credit cost for voice minutes and images created."""
        ...
        return (voice_minutes * self.voice_credit_rate) + (images_created * self.image_credit_rate)
