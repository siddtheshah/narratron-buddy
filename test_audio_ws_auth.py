...
from web_viewer_app import _can_access_agent_websocket
...
class TestCanAccessAgentWebsocket(unittest.TestCase):
    def test_allows_owner(self):
        ...
        self.assertTrue(_can_access_agent_websocket(request, deployment, current_user=current_user))
    ...
    def test_rejects_unrelated_user_without_join_key(self):
        ...
        self.assertFalse(_can_access_agent_websocket(request, deployment, current_user=current_user))
