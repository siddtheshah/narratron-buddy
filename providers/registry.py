...
_SPEECH_SPECS = (
    {
        ...
        "model_options": ["gemini-3.8-flash-tts", "gemini-3.8-flash-lite-tts"],
        "voice": "Kore",
        ...
        "status": "unconfigured",
        "notes": "Studio-quality Gemini TTS with structured delivery directions and complete WAV output.",
    },
    {
        "id": "fal-seed-speech",
