...
class TestCanvasStateManager(BaseTestCase):
    ...
    def test_tool_activity_is_transient_and_exposed_in_latest_state(self):
        ...
        manager.set_tool_activity("animation", True)
        ...
        self.assertTrue(manager.get_latest_state()["tool_activity"]["animation_generating"])
        ...
        manager.set_tool_activity("animation", False)
        ...
        self.assertFalse(manager.get_latest_state()["tool_activity"]["animation_generating"])
